...
const ChatMessage = ({ item }: Props) => {
  ...
  const removeMessageFromRoom = useRoomStore(
    (state) => state.removeMessageFromRoom
  );
  ...
  return (
    <>
      <Pressable
        ...
        maxW='80'
        _pressed={{
          bg: isFromConnectedUser
            ? darktheme.accentColorHover
            : darktheme.headerMenuColor,
        }}
        onLongPress={() => {
